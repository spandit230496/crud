...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = `<div class="action">
                       <a onClick="onEdit(this)"><i class="fa-solid fa-pen-to-square" style="color: #f0f0f0;"></i></a>
                       <a onClick="onDelete(this)"><i class="fa-solid fa-xmark" style="color: #ffffff;"></i></a>
                       </div>
                       `;
}
...
function onEdit(td) {
    document.getElementById("submit").inner="Update"
